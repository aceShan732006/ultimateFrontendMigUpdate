...
#### What it Does (What's)
- **Strict Incremental Analysis:** Enforces a strict, sequential version-by-version migration path (from v17 -> v18 only).
...
- **Migration Assessment Report (Markdown):** 
  - Focused 17 → 18 migration checklist and risk summary.
  ...
  - Targeted Angular 18 readiness pre-flight checklist.
